...
DeskWidget DeskCreateWidget(DeskWidgetClass wclass, DeskWidget parent, int num, ...) {
...
void DeskSetCoord(DeskWidget w, int x, int y, int width, int height, int flag){
	_DeskSetCoord(w->window, x, y, width, height, flag);
}
